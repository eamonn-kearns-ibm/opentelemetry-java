...
// Configure custom Maven local repository location
val mavenRepoLocal = System.getenv("MAVEN_REPO_LOCAL") 
    ?: "${System.getProperty("user.home")}/.m2/repository"

// Set the system property early, before any project configuration
System.setProperty("maven.repo.local", mavenRepoLocal)
